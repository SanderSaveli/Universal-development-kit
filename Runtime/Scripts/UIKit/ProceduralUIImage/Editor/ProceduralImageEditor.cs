...
namespace ProceduralUIImage.Editor
{
    ...
    public class ProceduralImageEditor : ImageEditor
    {
        ...
        SerializedProperty m_useGradient;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_useGradient);
        ...
        protected void ProceduralImageSpriteGUI()
        {
            ...
            {
                Sprite s = (Sprite)EditorGUILayout.ObjectField("Sprite", EmptySprite.IsEmptySprite((Sprite)m_Sprite.objectReferenceValue) ? null : m_Sprite.objectReferenceValue, typeof(Sprite), false,
                    GUILayout.Height(16));
                if (s != null)
                {
        ...
        void CheckForShaderChannelsGUI()
        {
            ...
            if (c != null && (c.additionalShaderChannels | AdditionalCanvasShaderChannels.TexCoord1 | AdditionalCanvasShaderChannels.TexCoord2 | AdditionalCanvasShaderChannels.TexCoord3) !=
